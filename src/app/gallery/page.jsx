        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Discover and share delicious homemade recipes with food lovers
                around the world.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a
                  href="#"
                  className="bg-gray-800 hover:bg-yellow-500 text-gray-400 hover:text-black p-3 rounded-full transition-all"
                >
          ...
          <div className="pt-8 border-t border-gray-800 text-center">
            <p className="text-gray-500 text-sm">
              © 2024 Ingredish. All rights reserved. Made with{" "}
