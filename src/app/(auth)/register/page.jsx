      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <div className="form-control">
              ...
              <input
                ...
                className="input input-bordered w-full bg-white border-2 border-gray-100 focus:border-yellow-500 focus:outline-none text-black placeholder-gray-400"
                value={name}
            ...
            <div className="form-control">
              ...
              <label className="label">
                <span className="label-text-alt text-gray-500 text-xs">Must be at least 6 characters</span>
              </label>
            </div>
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text text-black font-semibold">Confirm Password</span>
              </label>
              <div className="relative">
                <input
          ...
          <p className="text-center mt-6 text-black">
            ...
            <a href="/login" className="font-bold text-yellow-500 hover:text-yellow-600 transition-colors">
              Login
            </a>
          </p>
        </div>
